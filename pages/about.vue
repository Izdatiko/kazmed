<template>
  <div
    id="component-about"
    style="margin-bottom: 20px; border-radius: 32px"
    class="about"
  >
    ...
    <div class="about-content">
      <div class="about-content__license">
        <h1>Лицензии</h1>
        <p>
          KazMedEngineering обладает необходимыми лицензиями и сертификатами для
          предоставления авторизованных услуг. Компания получила официальное
          разрешение от Philips на распространение и обслуживание медицинского
          оборудования. Данная лицензия демонстрирует наше тесное партнерство и
          приверженность строгим стандартам Philips
        </p>
      </div>
      <div class="about-content__swiper">
        <div class="swiper-container">
